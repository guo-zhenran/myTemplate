...
\begin{titlepage}
    ...
    \colorbox{black!5}{%
        ...
        \parbox[t]{0.975\textwidth}{%
            ...
            \parbox[t]{0.95\textwidth}{%
                ...
                \texttt{myBook} Class \\[7.5pt]
                \large\bfseries A Comprehensive Demonstration
                \vspace{0.75cm}%
            }% 
        }%
    }% 
    ...
    % The 'parbox' is used to display horizontal rules on both sides of the authors' information.
    \parbox[t]{0.95\textwidth}{%
        ...
        \raggedleft
        \textcopyright\ Zhenran Guo\textsuperscript{\textdagger}%
        
        % Display the superscript \textdagger symbol and authors' affiliations.
        \normalsize\textsuperscript{\textdagger} SUFE, Shanghai, China\\[10pt]
